...
<section class="section-3 py-5 bg-2 ">
    <div class="container">     
        ...
        <div class="row pt-5">
            <div class="col-md-4 col-lg-3 sidebar mb-4" style="max-height: 750px; overflow-y: auto;">
                <div class="card border-0 shadow p-4" >
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check mb-2"> 
                            <input class="form-check-input " name="date_type" type="radio" value=" " id="">    
                            <label class="form-check-label " for="">Past 24 hours</label>
                        </div>

                        <div class="form-check mb-2"> 
                            <input class="form-check-input school-section" name="date_type" type="radio" value="7" id="">    
                            <label class="form-check-label " for="">Last Week</label>
                        </div>

                        <div class="form-check mb-2"> 
                            <input class="form-check-input school-section" name="date_type" type="radio" value="30" id="">    
                            <label class="form-check-label " for="">Last Month</label>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <h2>Job Type</h2>
                        <div class="form-check mb-2"> 
                            <input class="form-check-input school-section" name="walk_in_interview" type="checkbox" value="1" id="">    
                            <label class="form-check-label " for="">Walk In Interview</label>
                        </div>

                        <div class="form-check mb-2"> 
                            <input class="form-check-input school-section" name="work_from_home" type="checkbox" value="1" id="">    
                            <label class="form-check-label " for="">Work From Home</label>
                        </div>
                    </div>
                    ...
                    <div class='mb-4'>
                        ...
                        <div class="mb-4">
                            <h2>Salary Range</h2>
                            <div>
                                <span id="salary-range-display">0</span> <span id="currency-display">INR</span>
                            </div>
                            <input type="range" name="salary_range" min="0" max="100000" value="0" step="1000" oninput="updateSalaryDisplay(this.value)">
                        </div>
                                                <label for="salary_type">Select Currency:</label>
                        <select name="salary_type" id="salary_type" style="block-size:40px"         onchange="updateCurrencyDisplay()">
                        ...
                        <script>
                            function updateSalaryDisplay(value) {
                                document.getElementById('salary-range-display').textContent = value;
                            }
                    
                            function updateCurrencyDisplay() {
                                const currency = document.getElementById('salary_type').value;
